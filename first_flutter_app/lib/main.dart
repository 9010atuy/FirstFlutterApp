    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          //
          // C  olumn has various properties to control how it sizes itself and
          ...
          children: <Widget>[
            Text(
              'You have the clicked the button this many times:',
            ),
            Text(
              '$_counter',
...
class RandomWordsState extends State<RandomWords> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Start up Name Generator'), actions: <Widget>[
